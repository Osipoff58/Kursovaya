    ...
    try {
        ...
        do {
            if (opt == -1 or (char)opt == 'h') {
                cout << "Программа-сервер для вычисления суммы квадратов вектора может использовать следующие параметры:\n\n";
                ...
                cout << "\"j\" или \"journal\" – передает программе имя файла с журналом ошибок, необязательный.\n";
